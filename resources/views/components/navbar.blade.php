            ...
            <div class="relative ml-3">
              <div>
                ...
                class="relative flex max-w-xs items-center rounded-full bg-gray-800 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
                  ...
                  <img class="h-8 w-8 rounded-full" src="https://media.licdn.com/dms/image/D4E03AQFXJQAqu6oijA/profile-displayphoto-shrink_200_200/0/1707824936473?e=2147483647&v=beta&t=dDy_PXzHz0sFi_Yz2PxehAl_qb_CwxAesRWebP-4QJs" alt="">
                </button>
              </div>
              <div x-show="isOpen"
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
      ...
      <div class="border-t border-gray-700 pb-3 pt-4">
        <div class="flex items-center px-5">
          <div class="flex-shrink-0">
            <img class="h-10 w-10 rounded-full" src="https://media.licdn.com/dms/image/D4E03AQFXJQAqu6oijA/profile-displayphoto-shrink_200_200/0/1707824936473?e=2147483647&v=beta&t=dDy_PXzHz0sFi_Yz2PxehAl_qb_CwxAesRWebP-4QJs" alt="">
          </div>
          <div class="ml-3">
            <div class="text-base font-medium leading-none text-white">Anu Gerah</div>
            <div class="text-sm font-medium leading-none text-gray-400">anu@gmail.com</div>
          </div>
